            ...
            <Container>
                <nav className='flex justify-between px-4 py-1 '>
                    ...
                    <ul className='flex items-center gap-6 font-semibold'>
                        {navItems.map((item) =>
                            item.active ? (
                                <li onClick={() => navigate(item.slug)} className='max-md:hidden cursor-pointer border-zinc-200 hover:bg-zinc-200 hover:text-black border-2 rounded-2xl px-2 py-1' key={item.name}>
                                    {item.name}
                                </li>
                            ) : null
                        )}
